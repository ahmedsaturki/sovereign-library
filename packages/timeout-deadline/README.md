...
- child deadlines can only shorten a parent deadline
- `withDeadline()` races operation completion against the deadline and propagates cancellation through `AbortSignal`
