...
export function encodePathSegment(value, options = {}) { return encodeURIComponentSafe(value, options); }
export function decodePathSegment(value, options = {}) { return decodeURIComponentStrict(value, options); }
